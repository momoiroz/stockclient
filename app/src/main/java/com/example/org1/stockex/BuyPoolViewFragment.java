 ...
 */
public class BuyPoolViewFragment extends Fragment implements InvokeInterface {
    private ArrayList<OrderModel>  buyOrderModel;
    JsonElement element;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =inflater.inflate(R.layout.fragment_buy_pool_view, container, false);
        lv = v.findViewById(R.id.listview_buy);
                ...
                public void onResponse(Call<JsonElement> call, Response<JsonElement> response) {
                    ...
                    if (element == null||!element.equals(jtmp)) {
                        ...
                        if (!element.toString().equals("{}")) {
                            ...
                            int counter = 1;
                            int size = buyOrderModel.size();
                            for (int i = 0; i < buyOrderModel.size(); i++) {
                                if (buyOrderModel.get(i).getHolder().equals(holder)) {
                                    list.add(counter + ". " + buyOrderModel.get(size-i-1).toString());
                                    counter++;
                                }
                            }
